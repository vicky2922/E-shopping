...
if(isset($_POST['image']))
{
	...
	$res = @mysql_query("SELECT * FROM items WHERE category LIKE '%$name%'") or die(mysql_error());
...
?>
<div class="items">
	<a href='buy.php?item=1'><img id="<?php echo $ch ;?>" src="<?php echo $row['image'];?>" width="330px" height="350px"></a>
